...
class IconVisitor(Visitor):
    ...
    def visitAVI(self, avi):
        ...
        self.icon.setPixmap(QPixmap(avi.img_path).scaled(30, 30))
    
    def visitMP4(self, mp4):
        mp4.img_path = "icons/mp4-icon.png"
        self.icon.setPixmap(QPixmap(mp4.img_path).scaled(30, 30))
    
    def visitMKV(self, mkv):
        mkv.img_path = "icons/mkv-icon.png"
        self.icon.setPixmap(QPixmap(mkv.img_path).scaled(30, 30))   
    def visitVOB(self, vob):
        vob.img_path = "icons/vob-icon.png"
        self.icon.setPixmap(QPixmap(vob.img_path).scaled(30, 30))